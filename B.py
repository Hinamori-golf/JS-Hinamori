...
line = LINE(tokens, appName=newqr.HEADERS["ios_ipad"]["X-Line-Application"])
print ("----------- ยินดีต้อนรับเข้าสู้บอท hackmasgolf------------------")
...
admin =["ua6dd5e74ba6e099cf0696beb105a6dad"]
botStart = time.time()
kuciyose = {}
mulai = time.time()
...
RfuBot=[lineMID]
Family=["uf1f7fa1fe80ef4d302b0ad949c5ef9ef"]
admin=['uf1f7fa1fe80ef4d302b0ad949c5ef9ef']
staff = ["uf1f7fa1fe80ef4d302b0ad949c5ef9ef"]
...
#==============================================================================#
     ...
     #                    kittySend(receiver,"●•➤➤➤➤➤➤➤")
                         line.sendMessage(receiver,"ʜɪ ᴡᴇʟᴄᴏᴍ ᴛᴏ ᴍᴀsɢᴏʟғ")
     #                    kittySend(receiver,"●•➤➤➤➤➤➤➤➤➤➤➤➤")
                         targets = []
                         for g in gs.members:
                         ...
                         if targets == []:
                             line.sendMessage(receiver,"ᴏɴ ᴋɪᴄᴋ")
                         else:
                             for target in targets:
                                if not target in Rfu:
                                     try:
                                         ...
                                         line.sendMessage(receiver,"ᴅᴏɴᴇ: ᴋɪᴄᴋɢʀᴏᴜᴘ")
                                         print ("Cleanse Group")
#==============================================================================#
